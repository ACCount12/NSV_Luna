...
/obj/item/weapon/cell/attackby(obj/item/W, mob/user)
	...
	if(istype(W, /obj/item/weapon/reagent_containers/syringe))
		...
		if(S.reagents.has_reagent("plasma", 5) || S.reagents.has_reagent("fuel", 15))
			rigged = 1

			log_admin("LOG: [user.name] ([user.ckey]) injected a power cell with plasma or fuel, rigging it to explode.")
			message_admins("LOG: [user.name] ([user.ckey]) injected a power cell with plasma or fuel, rigging it to explode.")
